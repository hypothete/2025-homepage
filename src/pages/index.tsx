        ...
        <main className={styles.main}>
          ...
          <Section title="Art">
            ...
            <Gallery>
              <Item
                cropped
                original="/images/minecraft-skin.png"
                thumbnail="/images/minecraft-skin.png"
                width="453"
                height="565"
              >
                {({ ref, open }) => (
          ...
          <Section title="Writing">
            <p>
              I came out as trans in 2022, and since then I've been writing
              essays about my experiences in transition. I use my writing as a
              way to engage with queer theory, history, and media in order to
              better understand myself and what it means to be trans.
            </p>
          ...
          <Section title="Play">
            <ul>
              <li>
                I make stickers for sticking and shirts for wearing, here are
                some pics but I'm not selling any atm
              </li>
              <li>
